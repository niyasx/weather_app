          ...
          return SingleChildScrollView(
            ...
            child: RefreshIndicator(
              ...
              child: Container(
                ...
                decoration: themeprovider.themeMode ? darkBoxDec : lightBoxDec,
                    ...
                    children: [
                      themepro.isloading
                          ? SizedBox(
                              ...
                              child: const SizedBox(child: LinearProgressIndicator()))
                          : SizedBox(
                              height: screenSize.height * 0.03,
                            ),
                      Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Text(
                                pro.weatherModel?.cityName ?? "city not found",
                                style: GoogleFonts.poppins(
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: HourlyData(
                                ...
                                weathericon: pro.forecastweather!.hourly![index]
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: themepro.themeMode
                                    ...
                                    : const LinearGradient(
                                        colors: [
                                          Color.fromARGB(255, 107, 107, 236),
                                          Color.fromARGB(255, 153, 186, 232)
                                        ],
                                        begin: Alignment.bottomCenter,
                                        end: Alignment.topCenter,
                                        tileMode: TileMode.clamp,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    getDate(
                                        pro.forecastweather!.daily![index].dt),
                                    style: GoogleFonts.poppins(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600),
                                  ),
